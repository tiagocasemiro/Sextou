...
data class FeedPlaceUiModel(
    ...
    @param:StringRes val highlightResId: Int,
    @param:StringRes val distanceResId: Int,
    val rating: Float,
...
data class FeedUiState(
    val query: String = "",
    val places: List<FeedPlaceUiModel> = feedPlaces(),
...
fun FeedUiState.Companion.preview(): FeedUiState = FeedUiState()
